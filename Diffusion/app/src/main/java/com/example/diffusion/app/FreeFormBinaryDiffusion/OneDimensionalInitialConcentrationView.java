 ...
 */
public class OneDimensionalInitialConcentrationView extends View  {
    ...
    /* Constructor */
    public OneDimensionalInitialConcentrationView(Context context, AttributeSet atrs){
    ...
    public void onDraw(Canvas canvas){
        ...
        if(!linesOn) {
            for (int i = 0; i < dataPointArray.length; i++) {
                sketchCanvas.drawPoint(dataPointArray[i].getMidX(), dataPointArray[i].getYPosition(), sketchPaint); //TODO change made here
