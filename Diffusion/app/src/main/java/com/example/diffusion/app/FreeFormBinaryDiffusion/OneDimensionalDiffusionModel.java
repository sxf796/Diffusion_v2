...
public class OneDimensionalDiffusionModel {
    ...
    /* Constructor */
    public OneDimensionalDiffusionModel(float[] plottingValues, int animationViewHeight, String boundaryConditions, double deltaTFactor){
    ...
    public void setUpSolutionArray(){
        ...
        if(boundaryConditions.equals("No Flux")){
        ...
        } else if(boundaryConditions.equals("Reflective")){

            solutionValues[0] = solutionValues[(int)(solutionValues.length*0.1)];
            solutionValues[solutionValues.length-1] = solutionValues[(int)(solutionValues.length*0.8)];
