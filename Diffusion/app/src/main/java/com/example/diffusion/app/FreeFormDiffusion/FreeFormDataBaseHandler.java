 ...
 */
public class FreeFormDataBaseHandler extends SQLiteOpenHelper {

    //Database name and version, stored as final variables
    private static final String DATABASE_NAME = "free_form_database2.db";
    ...
    /* Default constructor */
    public FreeFormDataBaseHandler(Context context){
    ...
    public void onCreate(SQLiteDatabase db){
        ...
        String CREATE_TABLE_COMMAND = "CREATE TABLE " + TABLE_NAME + " (" +
                                       UNIQUE_ID + " INTEGER AUTOINCREMENT, " + //this might need changing in the future
    ...
    public ArrayList<String> getAllNames(){
        ...
        SQLiteDatabase db = this.getWritableDatabase();
        Cursor cursor = db.rawQuery("SELECT " + ROW_NAME + " FROM " + TABLE_NAME +
...
//will eventually need a method for getting all ids, images and names, for displaying in a scrollable type thing